...
public class SDCIController {
    ...
    public ResponseEntity<HashMap<String, Object>> registrarPartido(
        ...
        //System.out.printf(Integer.toString((partido.getDeporte().getIddeporte())));
    ...
    public ResponseEntity<List<Historialpartido>> buscarHistoralEquipo(@PathVariable("idEquipo") String idEquipo) {
        ...
        try {
            ...
            if (equipoOptional.isPresent()) {
                ...
                mensajeError("Debe guardar un valor aceptable");
                return ResponseEntity.notFound().build();
            }
        } catch (NumberFormatException e) {
            return ResponseEntity.badRequest().body(null);
    ...
    public ResponseEntity<HashMap<String, Object>> mensajeError( String mensaje){
        HashMap<String, Object> responseJson = new HashMap<>();

        responseJson.put("estado", mensaje);
